...
class PreferredCropsScreen extends StatefulWidget {
  @override
  _PreferredCropsScreenState createState() => _PreferredCropsScreenState();
}

class _PreferredCropsScreenState extends State<PreferredCropsScreen> {
