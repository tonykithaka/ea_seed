...
class _BuyerRegisterScreenState extends State<BuyerRegisterScreen> {
  ...
  getSelectedCounty(String selection, String qty) async {
    var buyerRepo = buyersRepo.BuyersRepo();
    var userType = "buyer";
    PreferredCropsResponse response =
        await buyerRepo.RegisterBuyerCounty(selection, userType, qty);
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: RaisedButton(
                  onPressed: () {
                    getSelectedCounty(_mySelection, qtyController.text);
