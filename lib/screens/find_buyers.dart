...
class AllBuyersCropsScreen extends StatefulWidget {
  @override
  _AllBuyersCropsScreenState createState() => _AllBuyersCropsScreenState();
}

class _AllBuyersCropsScreenState extends State<AllBuyersCropsScreen> {
    ...
    fetchCropBuyersDetails(String cropId) async {
      ...
      if (response != null) {
        setState(() {
          ...
          Navigator.pushNamed(context, "/cropBuyerDetails",
              arguments: response);
        });
      } else {
        setState(() {
                ...
                child: ListView(
                  children: <Widget>[
                    Container(
                      ...
                      child: Text('Products with buyers'),
                    ),
                    Container(
                      height: MediaQuery.of(context).size.height,
