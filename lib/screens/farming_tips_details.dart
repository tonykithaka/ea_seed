...
class FarmingTipDetailsScreen extends StatefulWidget {
//

  @override
  _FarmingTipDetailsScreenState createState() =>
      _FarmingTipDetailsScreenState();
}

class _FarmingTipDetailsScreenState extends State<FarmingTipDetailsScreen> {
